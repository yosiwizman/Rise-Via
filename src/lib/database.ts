...
console.log('🔵 DATABASE_URL check in database.ts:', {
  exists: !!DATABASE_URL,
  type: typeof DATABASE_URL,
  value: DATABASE_URL ? 'present' : 'missing'
});
...
try {
  ...
  sql = null;
  console.log('🔵 Neon initialization bypassed for debugging');
} catch (error) {
